...
def create_index():
	global lines_count,index_level,documents
	index_level=[]
	v1=int((documents)**(1/3.0))+1
	v2=v1**2
...
def shelve_retrieve():
	#d=shelve.open('./src/vars')
	global stopwords,index,lines_count,documents
